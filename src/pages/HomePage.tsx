...
export function HomePage() {
  ...
  return <>
    ...
    <section className="section-padding" aria-labelledby="featured-title">
      <div className="container">
        <div className="section-header section-header-inline" data-reveal="up"><div><span className="section-eyebrow">A short list to begin</span><h2 id="featured-title">Available lots</h2><p>Every card below comes from the shared NJ125 operations database.</p></div><Link className="btn btn-outline btn-sm" to="/properties">View all lots</Link></div>
        <div className="properties-grid" aria-live="polite">
          ...
          {!loading && !error && properties.length === 0 ? <div className="empty-state" data-reveal="up"><h3 className="empty-state-title">No properties available</h3><p className="empty-state-text">There are no published available lots in NJ125 right now.</p></div> : null}
